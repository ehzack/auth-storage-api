                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="wrapper" >
                             <tr>
                                <td align="center" valign="top"  class="logo">
                                   ...
                                   <img alt="Logo" src="${config.iconMail}" width="60" height="60" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;" border="0">
                                   </a>
                                </td>
                             </tr>
                          </table>
                                   ...
                                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                         <td>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                               <tr>
                                                  <td align="center" style="font-size: 2.5em; font-family: Roboto, Arial, sans-serif; color: #000000; padding-top: 30px;font-weight: bold;" class="padding">${i18n.title} ${config.name} !</td>
                                               </tr>
                                               <tr>
